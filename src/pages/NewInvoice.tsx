      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">
              {isEditMode
                ? `Modifier N°${form.invoice_number}`
                : "Nouvelle facture"}
            </h1>
        ...
        <div className="flex gap-2 sm:gap-3">
          <button
            ...
            disabled={generating}
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition-all shadow-sm text-sm sm:text-base"
          >
            {generating ? (
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-primary-600 hover:bg-primary-700 disabled:bg-gray-300 text-white font-medium rounded-xl transition-all shadow-lg shadow-primary-500/25 text-sm sm:text-base"
          >
            {saving ? (
              <Loader2 className="w-4 h-4 sm:w-5 sm:h-5 animate-spin" />
            ) : (
            ...
            {isEditMode ? "Sauvegarder" : "Créer"}<span className="hidden sm:inline"> & PDF</span>
          </button>
        </div>
      </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2 py-2 bg-white border border-gray-200 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-primary-500"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0,00"
                        className="w-full px-2 py-2 bg-white border border-gray-200 rounded-lg text-sm text-right focus:outline-none focus:ring-2 focus:ring-primary-500"
                      />
                    </div>
                    <div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end">
              <div className="bg-primary-50 px-4 sm:px-6 py-3 rounded-xl">
