...
export default function OnboardingBanner() {
  ...
  return (
    <div className="relative mb-6 sm:mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-[1px] border border-white/[0.08]">
      <div className="relative rounded-[15px] bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-4 sm:p-6 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-4">
              {checks.map((check) => (
                <div
                  key={check.key}
                  className={`flex items-center gap-1.5 text-xs font-medium px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full transition-all ${
                    check.done
          ...
          <Link
            to="/parametres"
            className="relative group flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 bg-white text-primary-700 font-bold rounded-xl transition-all duration-300 shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/15 hover:-translate-y-0.5 shrink-0"
          >
